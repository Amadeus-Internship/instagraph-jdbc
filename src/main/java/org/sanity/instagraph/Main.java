...
public class Main {
    public static Map<String, Executable> initializeCommands() {
        ...
        commands.put("query-comments-and-users", () -> new CommentsDaoImpl()
                .getCommentsAndUsers()
                .forEach(System.out::println));

        commands.put("query-high-quality-pictures", () -> new PicturesDaoImpl()
                .getHighQualityPictures()
                .forEach(System.out::println));

        commands.put("query-profile-pictures", () -> new PicturesDaoImpl()
                .getProfilePictures()
                .forEach(System.out::println));


        commands.put("query-spam-posts", () -> new PostsDaoImpl()
                .getSpamPosts()
                .forEach(System.out::println));

        commands.put("query-posts-and-commentators", () -> new PostsDaoImpl()
                .getPostsAndCommentators()
                .forEach(System.out::println));

        commands.put("query-most-popular-users", () -> new UsersDaoImpl()
                .getMostPopularUser()
                .forEach(System.out::println));
        ...
        commands.put("query-cheaters", () -> new UsersDaoImpl()
                .getCheaters()
                .forEach(System.out::println));

        commands.put("query-commenting-myself", () -> new UsersDaoImpl()
                .getCommentingMyself()
                .forEach(System.out::println));

        commands.put("query-user-top-posts", () -> new UsersDaoImpl()
                .getUserTopPosts()
                .forEach(System.out::println));


        commands.put("query-init-procedure-post", () -> {
            new CommentsDaoImpl().executeBlank(
        ...
        commands.put("query-init-procedure-filter", () -> {
            new CommentsDaoImpl().executeBlank(
                    "DROP PROCEDURE IF EXISTS udp_filter; " +
                            "DELIMITER $$ " +
                            "CREATE PROCEDURE udp_filter(hashtag VARCHAR(100)) " +
